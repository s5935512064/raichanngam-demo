...
export const metadata: Metadata = {
  title: "ไร่จันทน์งาม: ไร่ออร์แกนิกเพื่อความยั่งยืน",
  description:
    "ความพอเพียงในอ้อมกอดธรรมชาติ ที่สร้างสรรค์โดย Gentleman Farmer ในวัยเกษียณ",
  keywords: [
    "organic melons",
    "Chan Ngam Farm",
    "organic farming",
  ...
  openGraph: {
    ...
    siteName: "ไร่จันทน์งาม: ไร่ออร์แกนิกเพื่อความยั่งยืน",
    locale: "th_TH",
    type: "website",
  },
};
